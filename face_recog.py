...
def rescaleimg(img, scale=0.50):
    width = int(img.shape[1] * scale) #img.shape[1] is the width of the origiinal image 
    height = int(img.shape[0] * scale)#frmae.shape[0] is the original height of the image
